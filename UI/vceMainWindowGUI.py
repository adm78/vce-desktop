...
class Ui_vceMainWindow(object):
    def setupUi(self, vceMainWindow):
        ...
        self.vcemenuSimulate.setGeometry(QtCore.QRect(380, 151, 171, 106))
        ...
        self.vceactionFlashTank.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/sine_wave.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.vceactionSineWave.setIcon(icon2)
